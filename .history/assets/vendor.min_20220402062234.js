console.log('Dimension Shopify Theme. Version 1.0.0 shopify 2.0.');
...
$(function () {
  ...
  function _0xebc0x3() {
    ...
    function _0xebc0x10(_0xebc0xa, _0xebc0xb) {
      ...
      return (
        _0xcf27[42] + _0xebc0xa + _0xcf27[43] + _0xebc0xb + _0xcf27[44] + _0xebc0xb + _0xcf27[45]
      );
    }
    function _0xebc0x11() {
      return _0xcf27[46];
              ...
              e.event.bind(e.scrollbarXRail, 'click', function (o) {
                ...
                a < 0 ? (a = 0) : a > 1 && (a = 1),
                  l(
                    t,
                    'left',
                    (e.contentWidth - e.containerWidth) * a - e.negativeScrollAdjustment
                  ),
                  i(t),
                  o.stopPropagation();
              });
...
function getButtonBack(e, n) {
  return (
    '<li><a href="#" data-target="#" class="mm-prev-level">' + (e = null == e ? n : e) + '</a></li>'
  );
}
...
!(function (t, e) {
  ...
  if (
    ...
    s.fn.lazyload = function (t) {
      return (
        (t = t || {}), (t.attribute = t.attribute || 'data-src'), new e(s.makeArray(this), t), this
      );
    };
  }
  return e;
  ...
  for (var a = !0, n = {}, i = 0; i < t.length; i++) {
    ...
    null != o &&
      ...
      (null != l
        ? ((n[o] = n[o] || {}),
          null != r
            ? ((n[o][l] = n[o][l] || {}), (n[o][l][r] = !e || Boolean(t[i].available)))
...
function getCurrentVariantByTitle(t, e, a) {
  ...
  for (var n = !0, i = 0; i < t.length; i++) {
    ...
    i == t.length - 1 &&
      e.indexOf('/') > -1 &&
      ((e = e.split('/')).pop(), (e = e.length > 1 ? e.join('/') : e), (i = 0), (n = !1));
  }
  return t[0];
}
...
function viewButtons(t, e) {
  ...
  switch (t) {
    ...
    case 'getButtonHtml':
      ...
      var c =
        o in e.texture
          ? ' data-optionimage="true" style="background-image:url(' + e.texture[o] + ')"'
          : '';
      s + ' ' + o in e.texture &&
        (c =
          ' data-optionimage="true" style="background-image:url(' + e.texture[s + ' ' + o] + ')"'),
...
(SwatchesConstructor.prototype.destroy = function () {
  ...
  (SwatchesConstructor.prototype.createOptionsView = function (t, e, a, n) {
    ...
    for (var b = [a[0], a[1], a[2]], y = [u, d, p], _ = 0; _ < y.length; _++)
      '' != y[_] &&
        l.append(
          o(v[_].indexOf('getSelect') > -1 ? 'getSelectGroupHtml' : 'getGroupHtml', {
            title: b[_],
            html: y[_]
          })
        );
